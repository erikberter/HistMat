...
class ProfileAdmin(admin.ModelAdmin):
    list_filter = ['date_joined', 'last_login', 'is_superuser']
    ...
    fieldsets = [
        ...
        ('Informacion Tecnica', {'fields': ['last_login', 'date_joined', 'is_superuser', 'is_active', 'is_staff', 'user_permissions', 'groups'], 'classes': ['collapse']}),
    ]
